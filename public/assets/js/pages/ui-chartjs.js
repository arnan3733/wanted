...
var myBar = new Chart(ctxBar, {
    type: 'bar',
    data: {
        labels: ["ปปท.", "กปท. 1", "กปท. 2", "กปท. 3", "กปท. 4", "กปท. 5", "ปปท. เขต 1"],
        datasets: [{
...
var ctxBar = document.getElementById("line").getContext("2d");
var myBar = new Chart(ctxBar, {
    type: 'line',
    data: {
    ...
    options: {
        ...
        title: {
            display: true,
            text: "จำนวนหมายจับที่หมดอายุความ"
        },
        tooltips: {
            intersect: false,
...
var myChart = new Chart(ctx, {
    type: 'doughnut',
    data: {
        labels: ['เจ้าพนักงานเรียกรับ','ปฏิบัติหน้าที่โดยมิชอบ','ร่วมกันกระทำความผิด ปลอมแปลงเอกสาร(กรณีสวมบัตรประชาชน)','เป็นเจ้าพนักงานยักยอกทรัพย์','ยักยอกทรัพย์ พรบ.02','ป.อ.ม.157'],
        datasets: [{
            label: 'ประเภทข้อมูลหมายจับ',
            data: [7, 8, 10, 10, 20, 30],
            backgroundColor: [
                'rgba(255, 99, 132, 0.9)',
                'rgba(54, 162, 235, 0.9)',
                'rgba(255, 206, 86, 0.9)',
